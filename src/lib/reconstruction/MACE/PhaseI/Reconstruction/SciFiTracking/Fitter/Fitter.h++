...
concept Fitter =
    requires {
        typename T::Hit;
        typename T::Track;
        requires Mustard::Data::SuperTupleModel<typename T::Hit, MACE::PhaseI::Data::SciFiHit>;
...
concept SimFitter =
    requires {
        requires Fitter<T>;
        requires Mustard::Data::SuperTupleModel<typename T::Hit, MACE::PhaseI::Data::SciFiSimHit>;
        requires Mustard::Data::SuperTupleModel<typename T::Track, MACE::PhaseI::Data::Track>;
    };
