...
class GenFitSimpleKalmanFitter : public GenFitterBase<AHit, ATrack, genfit::KalmanFitter> {
private:
    using Base = GenFitterBase<AHit, ATrack, genfit::KalmanFitter>;
...
#include "MACE/PhaseI/Reconstruction/SciFiTracking/Fitter/GenFitSimpleKalmanFitter.inl"
